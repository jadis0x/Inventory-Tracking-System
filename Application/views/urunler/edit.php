                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategoriId" class="form-control">
                                    ...
                                    ?>
                                        <option <?php if ($params['data']['kategoriId'] == $value['id']) {
                                                    echo 'selected';
...
<script>
    $(document).ready(function() {
        ...
        $("#yeniEkle").click(function() {
            var temp = '<div class="col-md-6"><label>Ürün Özellik Adı: </label><input type="text" class="form-control selectOzellik" name="ozellik[' + i + '][value]"> </div><div class="col-md-6"><label>Ürün Özellik Değeri: </label><input type="text" class="form-control" name="ozellik[' + i + '][name]"></div>';
